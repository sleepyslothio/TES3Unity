...
namespace Demonixis.Toolbox.XR
{
    ...
    public abstract class XRDeviceBase : MonoBehaviour, IComparable
    {
        ...
        /// </summary>
        public abstract XRDeviceType VRDeviceType { get; }
        ...
        public virtual bool IsDualCamera => false;
        ...
        public abstract void SetTrackingSpaceType(TrackingSpaceType type, Transform headTransform, float height);
