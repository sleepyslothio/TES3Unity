...
namespace TES3Unity.Diagnostic
{
    public class NPC_Loader : MonoBehaviour
    {
        ...
        private void Tes_Initialized(TES3ManagerLite tes)
        {
            ...
            var npc = npcs[m_Index];

            // Instanciate NPC
            var npcObj = InstanciateNPC(m_NifManager, npc);
        ...
        private static Transform AddBodyPart(NIFManager nifManager, string path, Transform parent, bool invertXScale = false)
        {
