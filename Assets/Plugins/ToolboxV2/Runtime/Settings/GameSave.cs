...
namespace Demonixis.ToolboxV2
{
    ...
    public abstract class GameSave
    {
        ...
        public static string SaveData(GameSaveStorageMode storageMode, GameSave gameSave, string filename,
            string additionalFolder = null)
        {
            return SaveRawData(storageMode, gameSave, filename, additionalFolder);
        }
