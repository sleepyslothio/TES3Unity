...
static class CustomBuildProcessor
{
    ...
    private static string aar5 = Application.dataPath + "/Vendors/WaveVR/Plugins/Android/" + version_depended_aar + ".aar";
    private static string aar2017 = Application.dataPath + "/Vendors/WaveVR/Plugins/Android/" + version_depended_aar + "_2017.aar";
